---
source_path: "/en/contributing/writing-for-github-docs/templates"
title: "Templates"
intro: "This article contains starter templates for the different content types used in GitHub Docs."
...
breadcrumbs:
  ...
  - title: "Templates"
    href: "/en/contributing/writing-for-github-docs/templates"
---
...
Use the content model for full instructions and examples on how to write conceptual content. For more information, see [Concepts content type](/en/contributing/style-guide-and-content-model/concepts-content-type).
...
Use the content model for full instructions and examples on how to write reference content. For more information, see [Reference content type](/en/contributing/style-guide-and-content-model/reference-content-type).
...
<!-- rai-card-template-source: The GHD064 linter rule reads this code block as its source of truth. Do not remove this marker.
     The linter strips Liquid comment blocks before
     parsing, so edits within the comments will not affect linting.
     Changing, reordering, or removing any headings, or changing reusable references, WILL change what the linter enforces on all
     contentType: rai articles. -->
...
- [AUTOTITLE](/copilot/reference/ai-models/model-hosting)
{% endcomment %}
