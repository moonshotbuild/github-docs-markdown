---
source_path: "/en/contributing/writing-for-github-docs/using-yaml-frontmatter"
...
breadcrumbs:
  ...
  - title: "YAML frontmatter"
    href: "/en/contributing/writing-for-github-docs/using-yaml-frontmatter"
---
...
* Purpose: Indicates the [versions](https://github.com/github/docs/blob/main/src/versions/lib/all-versions.ts) to which a page applies.
  For more information about the different types of versioning, see [Versioning documentation](/en/contributing/writing-for-github-docs/versioning-documentation).
...
For more information, see [Configuring redirects](/en/contributing/writing-for-github-docs/configuring-redirects).
...
* Purpose: Override the initial tool selection for a page, where the tool refers to the application the reader is using to work with GitHub (such as GitHub.com's web UI, the GitHub CLI, or GitHub Desktop) or the GitHub APIs. For more information about the tool selector, see [Using Markdown and Liquid in GitHub Docs](/en/contributing/writing-for-github-docs/using-markdown-and-liquid-in-github-docs#tool-tags). If this frontmatter is omitted, then the tool-specific content matching the GitHub web UI is shown by default. If a user has indicated a tool preference (by clicking on a tool tab), then the user's preference will be applied instead of the default value.
