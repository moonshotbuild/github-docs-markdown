---
source_path: "/en/contributing/writing-for-github-docs/creating-screenshots"
title: "Creating screenshots"
intro: "You can help users locate elements of the user interface that are difficult to find by adding screenshots to GitHub Docs."
...
breadcrumbs:
  ...
  - title: "Create screenshots"
    href: "/en/contributing/writing-for-github-docs/creating-screenshots"
---
...
* Show interfaces in light theme wherever possible.
  * For GitHub, select "Light default" in your appearance settings. For more information, see [Managing your theme settings](/en/get-started/accessibility/managing-your-theme-settings).
