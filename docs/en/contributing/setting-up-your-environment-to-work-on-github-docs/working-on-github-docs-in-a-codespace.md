...
2. If you're an open source contributor, create a fork of the repository, then follow the rest of the steps in this procedure from your fork. For more information, see [Fork a repository](/en/pull-requests/how-tos/work-with-forks/fork-a-repo).
3. Create a branch to work on. For more information, see [Managing branches within your repository](/en/pull-requests/how-tos/commit-changes/managing-branches-within-your-repository).
