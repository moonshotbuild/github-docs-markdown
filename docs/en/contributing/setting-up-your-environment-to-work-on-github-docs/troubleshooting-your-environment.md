---
source_path: "/en/contributing/setting-up-your-environment-to-work-on-github-docs/troubleshooting-your-environment"
title: "Troubleshooting your environment"
intro: "Learn about troubleshooting problems in your local environment and the GitHub Docs staging platform."
...
breadcrumbs:
  ...
  - title: "Troubleshooting your environment"
    href: "/en/contributing/setting-up-your-environment-to-work-on-github-docs/troubleshooting-your-environment"
---
...
If you see an error resembling the one below, make sure single quotes are properly escaped in the frontmatter. Also, check the formatting in `redirect_from` blocks. For more information, see [Using YAML frontmatter](/en/contributing/writing-for-github-docs/using-yaml-frontmatter#escaping-single-quotes).
