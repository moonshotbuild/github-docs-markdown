---
source_path: "/en/migrations/elm/troubleshooting"
...
breadcrumbs:
  ...
  - title: "Troubleshooting"
    href: "/en/migrations/elm/troubleshooting"
---
...
3. Review exporter logs on the GitHub Enterprise Server appliance (requires SSH admin access):
...
4. If the exporter task has crashed, it should recover automatically. If it does not, contact GitHub Support.
