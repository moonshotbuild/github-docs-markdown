---
source_path: "/en/rest/authentication/permissions-required-for-fine-grained-personal-access-tokens"
title: "Permissions required for fine-grained personal access tokens"
intro: "For each permission granted to a fine-grained personal access token, these are the REST API endpoints that the app can use."
product: "REST API"
...
breadcrumbs:
  ...
  - title: "Permissions for fine-grained PATs"
    href: "/en/rest/authentication/permissions-required-for-fine-grained-personal-access-tokens"
---
...
| `POST /orgs/{org}/secret-scanning/custom-patterns` | write | PAT | ✗ |
| `DELETE /orgs/{org}/secret-scanning/custom-patterns` | write | PAT | ✗ |
| `PATCH /orgs/{org}/secret-scanning/custom-patterns/{pattern_id}` | write | PAT | ✗ |
...
| `GET /orgs/{org}/secret-scanning/custom-patterns` | read | PAT | ✗ |
...
| `GET /orgs/{org}/copilot/metrics/reports/repos-1-day` | read | PAT | ✗ |
...
| `GET /repos/{owner}/{repo}/interaction-limits/pulls/bypass-list` | write | PAT | ✗ |
| `PUT /repos/{owner}/{repo}/interaction-limits/pulls/bypass-list` | write | PAT | ✗ |
| `DELETE /repos/{owner}/{repo}/interaction-limits/pulls/bypass-list` | write | PAT | ✗ |
| `GET /repos/{owner}/{repo}/interaction-limits/pulls/creation-cap` | write | PAT | ✗ |
| `PATCH /repos/{owner}/{repo}/interaction-limits/pulls/creation-cap` | write | PAT | ✗ |
...
| Endpoint | Access | Tokens | Additional Permissions |
|----------|--------|--------|------------------------|
| `GET /repos/{owner}/{repo}/code-quality/findings` | read | PAT | ✗ |
| `GET /repos/{owner}/{repo}/code-quality/findings/{finding_number}` | read | PAT | ✗ |
...
| `GET /repos/{owner}/{repo}/issue-types` | read | PAT | ✗ |
