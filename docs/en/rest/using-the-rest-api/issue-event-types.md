---
source_path: "/en/rest/using-the-rest-api/issue-event-types"
title: "Issue event types"
intro: "For the REST APIs for issue events and timeline events, learn about each event type, the triggering action on GitHub, and each event's unique properties."
product: "REST API"
...
breadcrumbs:
  ...
  - title: "Issue event types"
    href: "/en/rest/using-the-rest-api/issue-event-types"
---
...
The issue or pull request was linked to another issue or pull request. For more information, see [Linking a pull request to an issue](/en/issues/tracking-your-work-with-issues/using-issues/linking-a-pull-request-to-an-issue).
...
The issue or pull request was unlinked from another issue or pull request. For more information, see [Linking a pull request to an issue](/en/issues/tracking-your-work-with-issues/using-issues/linking-a-pull-request-to-an-issue).
