---
source_path: "/en/rest/using-the-rest-api/using-cors-and-jsonp-to-make-cross-origin-requests"
...
breadcrumbs:
  ...
  - title: "CORS and JSONP"
    href: "/en/rest/using-the-rest-api/using-cors-and-jsonp-to-make-cross-origin-requests"
---
