---
source_path: "/en/rest/using-the-rest-api/troubleshooting-the-rest-api"
...
breadcrumbs:
  ...
  - title: "Troubleshooting"
    href: "/en/rest/using-the-rest-api/troubleshooting-the-rest-api"
---
...
GitHub enforces rate limits to ensure that the API stays available for all users. For more information, see [Rate limits for the REST API](/en/rest/using-the-rest-api/rate-limits-for-the-rest-api).
...
For more information about how to avoid exceeding the rate limits, see [Best practices for using the REST API](/en/rest/using-the-rest-api/best-practices-for-using-the-rest-api).
...
For more information about authentication, see [Authenticating to the REST API](/en/rest/authentication/authenticating-to-the-rest-api).
...
Basic authentication with your username and password is not supported. Instead, you should use a personal access token or an access token for a GitHub App or OAuth app. For more information, see [Authenticating to the REST API](/en/rest/authentication/authenticating-to-the-rest-api).
...
For more information, see [API Versions](/en/rest/about-the-rest-api/api-versions).
