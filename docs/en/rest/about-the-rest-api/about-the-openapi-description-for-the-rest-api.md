---
source_path: "/en/rest/about-the-rest-api/about-the-openapi-description-for-the-rest-api"
title: "About the OpenAPI description for the REST API"
intro: "The GitHub REST API is fully described in an OpenAPI compliant document."
product: "REST API"
...
breadcrumbs:
  ...
  - title: "OpenAPI description"
    href: "/en/rest/about-the-rest-api/about-the-openapi-description-for-the-rest-api"
---
...
For each product, if date-based versioning is supported, there is also a description for each date-based version. For more information, see [API Versions](/en/rest/about-the-rest-api/api-versions).
