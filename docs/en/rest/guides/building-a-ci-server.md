---
source_path: "/en/rest/guides/building-a-ci-server"
...
breadcrumbs:
  ...
  - title: "Guides"
    href: "/en/rest/guides"
  - title: "Building a CI server"
    href: "/en/rest/guides/building-a-ci-server"
---
...
to [use it](/en/webhooks/using-webhooks/handling-webhook-deliveries#using-ngrok). We find it to be a very useful tool for exposing local
...
[a personal access token](/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens):
