---
source_path: "/en/desktop/managing-commits/reordering-commits-in-github-desktop"
title: "Reordering commits in GitHub Desktop"
intro: "You can use GitHub Desktop to reorder commits in your branch's history."
...
breadcrumbs:
  ...
  - title: "Reordering commits"
    href: "/en/desktop/managing-commits/reordering-commits-in-github-desktop"
---
...
* A message states that there are merge conflicts that you must resolve before the application can continue reordering commits on your branch.
  ...
  2. Resolve any merge conflicts in your preferred way, using a text editor, the command line, or another tool. For more information, see [Merge and close pull requests](/en/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts).
