---
source_path: "/en/desktop/making-changes-in-a-branch/committing-and-reviewing-changes-to-your-project-in-github-desktop"
title: "Committing and reviewing changes to your project in GitHub Desktop"
intro: "GitHub Desktop tracks all changes to all files as you edit them. You can decide how to group the changes to create meaningful commits."
...
breadcrumbs:
  ...
  - title: "Commit & review changes"
    href: "/en/desktop/making-changes-in-a-branch/committing-and-reviewing-changes-to-your-project-in-github-desktop"
---
...
1. At the bottom of the list of changes, next to your profile picture, describe your commit:
   ...
   * To choose the model used to generate commit messages, configure Copilot settings. For more information, see [Configuring Copilot in GitHub Desktop](/en/desktop/configuring-and-customizing-github-desktop/configuring-copilot-in-github-desktop).
   * Copilot uses any repository custom instructions to shape the generated commit message and details. For more information, see [Adding repository custom instructions for GitHub Copilot](/en/enterprise-cloud@latest/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions/add-repository-instructions).
   * Copilot also uses any repository rulesets that restrict commit metadata to shape the generated commit message and details. For more information, see [Creating rulesets for a repository](/en/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/creating-rulesets-for-a-repository#adding-metadata-restrictions).
