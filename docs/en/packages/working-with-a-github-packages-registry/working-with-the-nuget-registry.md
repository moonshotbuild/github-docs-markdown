---
source_path: "/en/packages/working-with-a-github-packages-registry/working-with-the-nuget-registry"
title: "Working with the NuGet registry"
intro: "You can configure the dotnet command-line interface (CLI) to publish NuGet packages to GitHub Packages and to use packages stored on GitHub Packages as dependencies in a .NET project."
...
breadcrumbs:
  ...
  - title: "NuGet registry"
    href: "/en/packages/working-with-a-github-packages-registry/working-with-the-nuget-registry"
---
...
If you don't already have a personal access token to use for your account on GitHub, see [Managing your personal access tokens](/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens).
