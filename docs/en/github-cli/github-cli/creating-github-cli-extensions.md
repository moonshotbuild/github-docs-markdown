---
source_path: "/en/github-cli/github-cli/creating-github-cli-extensions"
title: "Creating GitHub CLI extensions"
intro: "Learn how to share new GitHub CLI commands with other users by creating custom extensions for GitHub CLI."
product: "GitHub CLI"
...
breadcrumbs:
  ...
  - title: "Creating GitHub CLI extensions"
    href: "/en/github-cli/github-cli/creating-github-cli-extensions"
---
...
8. Optionally, to help other users discover your extension, add the repository topic `gh-extension`. This will make the extension appear on the [`gh-extension` topic page](https://github.com/topics/gh-extension). For more information about how to add a repository topic, see [Classifying your repository with topics](/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/classifying-your-repository-with-topics).
