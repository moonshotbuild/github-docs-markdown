---
source_path: "/en/graphql/guides/using-the-graphql-api-for-discussions"
...
breadcrumbs:
  ...
  - title: "Use GraphQL for Discussions"
    href: "/en/graphql/guides/using-the-graphql-api-for-discussions"
---
...
Discussion may be returned from the top-level `search` field. To search for discussion, specify `type` as `DISCUSSION`. The `SearchResultItemConnection` type has a `discussionCount` field to report the number of returned discussions, and the `Discussion` type is added to the `SearchResultItem` union. For more information, see [Search](/en/graphql/reference/search#query-searchresultitemconnection) and [Searching discussions](/en/search-github/searching-on-github/searching-discussions).
