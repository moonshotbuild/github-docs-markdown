---
source_path: "/en/graphql/overview/changelog"
title: "Changelog"
...
* Enum value 'WONT\_FIXwas added to enumPullRequestReviewThreadResolutionReason'
...
* Enum value 'SECURITY\_KEYwas added to enumProofOfPresenceRequirement'
...
* Enum value 'MULTI\_SELECTwas added to enumProjectV2CustomFieldType'
* Member 'ProjectV2MultiSelectFieldwas added to Union typeProjectV2FieldConfiguration'
* Enum value 'MULTI\_SELECTwas added to enumProjectV2FieldType'
...
* Enum value 'NO\_POLICYwas added to enumProofOfPresenceRequirement'
...
* Enum value 'ARCHIVED\_EVENTwas added to enumPullRequestTimelineItemsItemType'
* Enum value 'UNARCHIVED\_EVENTwas added to enumPullRequestTimelineItemsItemType'
...
* Enum value 'LICENSE\_COMPLIANCE\_SCANNINGwas added to enumRepositoryRuleType'
...
* Enum value 'COLLABORATORS\_ONLYwas added to enumIssueCreationPolicy'
...
* Enum value 'NOT\_ARCHIVEDwas added to enumProjectV2ItemArchivedState'
...
* Enum value 'LOW\_QUALITYwas added to enumReportedContentClassifiers'
...
* Enum value 'CREATED\_ATwas added to enumEnterpriseTeamMemberOrderField'
...
* Enum value 'CREATED\_ATwas added to enumEnterpriseTeamOrderField'
...
* Enum value 'CREATED\_ATwas added to enumEnterpriseTeamOrganizationOrderField'
...
* Enum value 'MULTI\_SELECTwas added to enumIssueFieldDataType'
