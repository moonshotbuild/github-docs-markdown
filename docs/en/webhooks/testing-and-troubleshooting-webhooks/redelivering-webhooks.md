---
source_path: "/en/webhooks/testing-and-troubleshooting-webhooks/redelivering-webhooks"
title: "Redelivering webhooks"
intro: "To help recover from failed deliveries, you can redeliver webhook deliveries from the past 3 days."
product: "Webhooks"
...
breadcrumbs:
  ...
  - title: "Testing and troubleshooting webhooks"
    href: "/en/webhooks/testing-and-troubleshooting-webhooks"
  - title: "Redeliver webhooks"
    href: "/en/webhooks/testing-and-troubleshooting-webhooks/redelivering-webhooks"
---
...
You can use the GitHub web interface or the REST API to redeliver webhooks for a repository. For more information about using the REST API to redeliver webhooks, see [REST API endpoints for repository webhooks](/en/rest/repos/webhooks).
