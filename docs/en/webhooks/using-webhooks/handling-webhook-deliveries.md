---
source_path: "/en/webhooks/using-webhooks/handling-webhook-deliveries"
...
breadcrumbs:
  ...
  - title: "Handle deliveries"
    href: "/en/webhooks/using-webhooks/handling-webhook-deliveries"
---
...
In your code that handles webhook deliveries, you should validate that the delivery is from GitHub before processing the delivery further. For more information, see [Validating webhook deliveries](/en/webhooks/using-webhooks/validating-webhook-deliveries).
