---
source_path: "/en/webhooks/using-webhooks/disabling-webhooks"
title: "Disabling webhooks"
intro: "You can disable a webhook to unsubscribe from events that occur on GitHub."
product: "Webhooks"
...
breadcrumbs:
  ...
  - title: "Disable webhooks"
    href: "/en/webhooks/using-webhooks/disabling-webhooks"
---
...
You can use the GitHub web interface or the REST API to delete a webhook for a repository. For more information about using the REST API to delete a repository webhook, see [REST API endpoints for repository webhooks](/en/rest/repos/webhooks#delete-a-repository-webhook).
