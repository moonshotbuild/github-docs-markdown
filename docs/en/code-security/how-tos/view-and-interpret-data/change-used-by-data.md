---
source_path: "/en/code-security/how-tos/view-and-interpret-data/change-used-by-data"
...
breadcrumbs:
  ...
  - title: "Change \"used by\" data"
    href: "/en/code-security/how-tos/view-and-interpret-data/change-used-by-data"
---
...
Some repositories have a "Used by" section in the sidebar of the **Code** tab. This section shows the number of public references to a package that were found, and displays the avatars of some of the owners of the dependent projects. For more information, see [Dependency graph](/en/code-security/concepts/supply-chain-security/dependency-graph#dependents-and-used-by-data).
