---
source_path: "/en/code-security/how-tos/secure-your-secrets/detect-secret-leaks/enabling-secret-scanning-for-ai-detected-secrets"
title: "Enabling generic secret detection for AI-detected secrets"
intro: "You can enable generic secret detection for your repository or organization. Alerts for generic secrets, such as passwords, are displayed in a separate list on the secret scanning alerts page."
...
breadcrumbs:
  ...
  - title: "Enable generic secret detection"
    href: "/en/code-security/how-tos/secure-your-secrets/detect-secret-leaks/enabling-secret-scanning-for-ai-detected-secrets"
---
...
For information on how to view alerts for generic secrets that have been detected with AI, see [Viewing and filtering alerts from secret scanning](/en/code-security/how-tos/manage-security-alerts/manage-secret-scanning-alerts/viewing-alerts).

## Further reading

* [Application card: GitHub security and quality AI features](/en/code-security/responsible-use/security-and-quality-ai-features)
