---
source_path: "/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/test-custom-queries"
title: "Testing custom queries"
intro: "Verify your custom CodeQL queries and catch breaking changes before they affect your code scanning results following new releases of the CodeQL CLI."
...
breadcrumbs:
  ...
  - title: "Test custom queries"
    href: "/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/test-custom-queries"
---
...
to specify a fixed version of the pack. The `extractor` defines which language the CLI will use to create test databases from the code files stored in this CodeQL pack. For more information, see [Customizing analysis with CodeQL packs](/en/code-security/tutorials/customize-code-scanning/customize-analysis).
...
* A query reference file (`.qlref` file) defining the location of the query to test. The location is defined relative to the root of the CodeQL pack that contains the query. Usually, this is a CodeQL pack specified in the `dependencies` block of the test pack. For more information, see [Query reference files](/en/code-security/concepts/code-scanning/codeql/query-reference-files).
...
For full details of all the options you can use when testing queries, see [test run](/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/test-run).
...
3. Compiles the query referenced by the `EmptyThen.qlref` file.
   ...
   For information about saving the search path as part of your configuration, see [Specifying command options in a CodeQL configuration file](/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/specify-command-options).
...
`Test.java` example code. For more information, see [Managing CodeQL databases](/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/manage-codeql-databases#choosing-a-database-to-analyze).
