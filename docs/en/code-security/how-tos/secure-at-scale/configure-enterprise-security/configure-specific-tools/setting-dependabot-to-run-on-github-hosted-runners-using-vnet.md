---
source_path: "/en/code-security/how-tos/secure-at-scale/configure-enterprise-security/configure-specific-tools/setting-dependabot-to-run-on-github-hosted-runners-using-vnet"
title: "Setting up Dependabot to run on github-hosted action runners using the Azure Private Network"
intro: "You can configure an Azure Virtual Network (VNET) to run Dependabot on GitHub-hosted runners."
...
breadcrumbs:
  ...
  - title: "Configure enterprise security"
    href: "/en/code-security/how-tos/secure-at-scale/configure-enterprise-security"
  - title: "Configure specific tools"
    href: "/en/code-security/how-tos/secure-at-scale/configure-enterprise-security/configure-specific-tools"
  - title: "Configure VNET"
    href: "/en/code-security/how-tos/secure-at-scale/configure-enterprise-security/configure-specific-tools/setting-dependabot-to-run-on-github-hosted-runners-using-vnet"
---
...
You now need to enable Dependabot on *self-hosted runners* for your organization in order to enable Dependabot on large runners. See [Enabling or disabling Dependabot on larger runners](/en/code-security/concepts/supply-chain-security/dependabot-on-actions).
