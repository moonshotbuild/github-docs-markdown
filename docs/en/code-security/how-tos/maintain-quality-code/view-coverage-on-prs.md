...
> \[!NOTE]
> The coverage summary comment reports **line coverage**. See [Code coverage reference](/en/code-security/reference/code-quality/code-coverage).
...
* **Branch-vs-default-branch comparison:** The aggregate line coverage percentage for the pull request branch and the default branch (for example, "65% on pull request branch, 44% on default branch").
