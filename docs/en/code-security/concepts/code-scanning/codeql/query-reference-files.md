---
source_path: "/en/code-security/concepts/code-scanning/codeql/query-reference-files"
...
breadcrumbs:
  ...
  - title: "Query reference files"
    href: "/en/code-security/concepts/code-scanning/codeql/query-reference-files"
---
...
For another example, see [Testing custom queries](/en/code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/test-custom-queries).
