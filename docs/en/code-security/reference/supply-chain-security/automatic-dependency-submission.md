---
source_path: "/en/code-security/reference/supply-chain-security/automatic-dependency-submission"
...
breadcrumbs:
  ...
  - title: "Automatic dependency submission"
    href: "/en/code-security/reference/supply-chain-security/automatic-dependency-submission"
---
...
1. Provision a larger runner at the organization level with the name `dependency-submission`. For more information, see [Adding a larger runner to an organization](/en/actions/how-tos/manage-runners/larger-runners/manage-larger-runners#adding-a-larger-runner-to-an-organization).
2. Give your repository access to the runner. For more information, see [Allowing repositories to access larger runners](/en/actions/how-tos/manage-runners/larger-runners/manage-larger-runners#allowing-repositories-to-access-larger-runners).
...
If your internal repository allows anonymous read access, you only need to set `GRADLE_PLUGIN_REPOSITORY_URL` and can omit the credential variables entirely, avoiding this concern. If the repository requires authentication, use read-only credentials and a dedicated runner. For organization- or enterprise-level runners, also restrict runner-group access to only the repositories that need these credentials. See [Managing access to self-hosted runners using groups](/en/actions/how-tos/manage-runners/self-hosted-runners/manage-access).
