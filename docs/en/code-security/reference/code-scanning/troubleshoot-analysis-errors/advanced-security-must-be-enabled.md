---
source_path: "/en/code-security/reference/code-scanning/troubleshoot-analysis-errors/advanced-security-must-be-enabled"
title: "Error: \"GitHub Code Security or GitHub Advanced Security must be enabled for this repository to use code scanning\""
intro: "If you see this error, make sure that GitHub Code Security is enabled."
...
breadcrumbs:
  ...
  - title: "Code Security must be enabled"
    href: "/en/code-security/reference/code-scanning/troubleshoot-analysis-errors/advanced-security-must-be-enabled"
---
