---
source_path: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/query-run"
title: "query run"
...
breadcrumbs:
  ...
  - title: "query run"
    href: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/query-run"
---
