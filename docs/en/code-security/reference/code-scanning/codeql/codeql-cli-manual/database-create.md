---
source_path: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-create"
title: "database create"
intro: "Create a CodeQL database for a source tree that can be analyzed using\none of the CodeQL products."
...
breadcrumbs:
  ...
  - title: "database create"
    href: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-create"
---
...
to [Workflow configuration options for code scanning](/en/code-security/reference/code-scanning/workflow-configuration-options). To run queries from
