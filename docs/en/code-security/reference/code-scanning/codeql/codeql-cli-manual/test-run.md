---
source_path: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/test-run"
title: "test run"
...
breadcrumbs:
  ...
  - title: "test run"
    href: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/test-run"
---
