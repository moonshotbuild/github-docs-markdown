---
source_path: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-trace-command"
...
breadcrumbs:
  ...
  - title: "database trace-command"
    href: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-trace-command"
---
...
`--source-root` passed to [codeql database create](/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-create), if one exists. If no `--source-root` argument is provided, the current working directory is
used.
