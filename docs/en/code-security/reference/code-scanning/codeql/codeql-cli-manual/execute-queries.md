---
source_path: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/execute-queries"
...
breadcrumbs:
  ...
  - title: "execute queries"
    href: "/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/execute-queries"
---
