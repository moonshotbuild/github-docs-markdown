---
source_path: "/en/code-security/tutorials/trialing-github-advanced-security/enable-security-features-trial"
title: "Enabling security features in your trial enterprise"
intro: "Quickly create an enterprise-level configuration and apply Secret Protection and Code Security features across all repositories in your trial enterprise."
...
breadcrumbs:
  ...
  - title: "Enable security features in trial"
    href: "/en/code-security/tutorials/trialing-github-advanced-security/enable-security-features-trial"
---
...
This article assumes that you have planned and then started a trial of GitHub Advanced Security. For more information, see [Planning a trial of GitHub Advanced Security](/en/code-security/tutorials/trialing-github-advanced-security/planning-a-trial-of-ghas).
...
5. Optionally, click the **Repositories** tab, then in the "Apply configurations" section, use the "Search repositories" field or **Filter** button to filter repositories. Then select one or more repositories and use the **Apply configuration** button to choose a configuration to apply to those repositories.

For more information, see [Applying a custom security configuration](/en/code-security/how-tos/secure-at-scale/configure-organization-security/establish-complete-coverage/apply-custom-configuration).
...
1. [Exploring your enterprise trial of GitHub Secret Protection](/en/code-security/tutorials/trialing-github-advanced-security/explore-trial-secret-scanning)
2. [Exploring your enterprise trial of GitHub Code Security](/en/code-security/tutorials/trialing-github-advanced-security/explore-trial-code-scanning)
