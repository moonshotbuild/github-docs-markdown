---
source_path: "/en/authentication/keeping-your-account-and-data-secure/removing-sensitive-data-from-a-repository"
title: "Removing sensitive data from a repository"
intro: "Sensitive data can be removed from the history of a repository if you can carefully coordinate with everyone who has cloned it and you are willing to manage the side effects."
...
breadcrumbs:
  ...
  - title: "Remove sensitive data"
    href: "/en/authentication/keeping-your-account-and-data-secure/removing-sensitive-data-from-a-repository"
---
...
Preventing contributors from making accidental commits can help you prevent sensitive information from being exposed. For more information see [Best practices for preventing data leaks in your organization](/en/code-security/tutorials/secure-your-organization/prevent-data-leaks).
...
* Enable push protection for your repository to detect and prevent pushes which contain hardcoded secrets from being committed to your codebase. For more information, see [Push protection](/en/code-security/concepts/secret-security/push-protection).
