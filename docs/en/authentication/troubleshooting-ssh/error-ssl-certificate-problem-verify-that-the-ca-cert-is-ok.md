---
source_path: "/en/authentication/troubleshooting-ssh/error-ssl-certificate-problem-verify-that-the-ca-cert-is-ok"
title: "Error: SSL certificate problem, verify that the CA cert is OK"
intro: "This error means your CA root certificate is out of date. If your CA root certificate needs to be updated, you won't be able to push or pull from GitHub repositories."
...
breadcrumbs:
  ...
  - title: "SSL certificate problem"
    href: "/en/authentication/troubleshooting-ssh/error-ssl-certificate-problem-verify-that-the-ca-cert-is-ok"
---
