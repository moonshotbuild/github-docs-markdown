---
source_path: "/en/copilot/reference/enterprise-administrators/agent-session-filters"
...
breadcrumbs:
  ...
  - title: "Agent session filters"
    href: "/en/copilot/reference/enterprise-administrators/agent-session-filters"
---
