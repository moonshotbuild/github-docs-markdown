---
source_path: "/en/copilot/reference/copilot-usage-metrics/example-schema"
title: "Example schema for Copilot usage metrics"
intro: "See an example schema of the data returned by the Copilot usage metrics API."
...
breadcrumbs:
  ...
  - title: "Example schema"
    href: "/en/copilot/reference/copilot-usage-metrics/example-schema"
---
