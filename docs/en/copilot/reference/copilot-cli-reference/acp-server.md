---
source_path: "/en/copilot/reference/copilot-cli-reference/acp-server"
title: "Copilot CLI ACP server"
intro: "Learn about GitHub Copilot CLI's Agent Client Protocol server."
...
breadcrumbs:
  ...
  - title: "ACP server"
    href: "/en/copilot/reference/copilot-cli-reference/acp-server"
---
...
ACP mode allows sessions with a configured bring-your-own-key (BYOK) provider (`COPILOT_PROVIDER_*` environment variables, or a providers configuration file—see `COPILOT_PROVIDERS_CONFIG` in [GitHub Copilot CLI command reference](/en/copilot/reference/copilot-cli-reference/cli-command-reference#environment-variables)) to run without GitHub login, matching the behavior of `-p`/interactive mode.
...
For a complete list of slash commands for Copilot CLI, see [GitHub Copilot CLI command reference](/en/copilot/reference/copilot-cli-reference/cli-command-reference#slash-commands-in-the-interactive-interface).
