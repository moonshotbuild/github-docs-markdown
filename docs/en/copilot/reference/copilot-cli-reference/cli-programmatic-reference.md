---
source_path: "/en/copilot/reference/copilot-cli-reference/cli-programmatic-reference"
title: "GitHub Copilot CLI programmatic reference"
intro: "Find options for running Copilot CLI programmatically."
...
breadcrumbs:
  ...
  - title: "Copilot CLI reference"
    href: "/en/copilot/reference/copilot-cli-reference"
  - title: "CLI programmatic reference"
    href: "/en/copilot/reference/copilot-cli-reference/cli-programmatic-reference"
---
...
| memory       | Storing new facts to the agent's persistent memory. This does not affect using existing memories. See [About GitHub Copilot Memory](/en/copilot/concepts/agents/copilot-memory).                                                         |
...
> \[!NOTE]
> To see the model strings for all available models, run the `/model` command in an interactive Copilot CLI session. For the full list of models and the clients that support them, see [Supported AI models in GitHub Copilot](/en/copilot/reference/ai-models/supported-models).
