---
source_path: "/en/copilot/concepts/enterprise/mcp-management"
...
breadcrumbs:
  ...
  - title: "MCP management"
    href: "/en/copilot/concepts/enterprise/mcp-management"
---
...
| Supported clients      | Clients supported by the `managed-settings.json` file, see [Getting started with enterprise-managed settings](/en/copilot/how-tos/administer-copilot/manage-for-enterprise/use-managed-settings/get-started). Planned to expand in the near future. | See [MCP private registry enforcement](/en/copilot/reference/enterprise-administrators/mcp-private-registry-enforcement). |
