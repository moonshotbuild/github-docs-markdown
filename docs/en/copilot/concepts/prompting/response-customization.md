---
source_path: "/en/copilot/concepts/prompting/response-customization"
title: "About customizing GitHub Copilot responses"
intro: "Learn about customizing the behavior of GitHub Copilot to fit with your preferences and requirements."
...
breadcrumbs:
  ...
  - title: "Prompting"
    href: "/en/copilot/concepts/prompting"
  - title: "Response customization"
    href: "/en/copilot/concepts/prompting/response-customization"
---
...
You can customize how Copilot Chat responds to you on GitHub.com by adding personal instructions, which Copilot will only apply to you. You do this in a popup on the Copilot Chat page on GitHub.com. See [Adding personal custom instructions for GitHub Copilot](/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions/add-personal-instructions).
