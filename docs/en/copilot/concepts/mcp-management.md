...
| Supported clients      | Clients supported by the `managed-settings.json` file, see [Configuring enterprise-managed settings](/en/copilot/how-tos/administer-copilot/manage-for-enterprise/manage-agents/configure-enterprise-managed-settings). Planned to expand in the near future. | See [MCP private registry enforcement](/en/copilot/reference/mcp-allowlist-enforcement).                         |
