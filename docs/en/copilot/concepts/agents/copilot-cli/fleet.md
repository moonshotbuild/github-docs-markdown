---
source_path: "/en/copilot/concepts/agents/copilot-cli/fleet"
title: "Running tasks in parallel with the /fleet command"
intro: "The /fleet slash command lets Copilot CLI break down a complex request into smaller tasks and run them in parallel, maximizing efficiency and throughput."
...
breadcrumbs:
  ...
  - title: "Parallel task execution"
    href: "/en/copilot/concepts/agents/copilot-cli/fleet"
---
...
This article gives an overview of the `/fleet` slash command. For details of how to use it, see [Speeding up task completion with the \`/fleet\` command](/en/copilot/how-tos/copilot-cli/use-copilot-cli/speed-up-task-completion).
