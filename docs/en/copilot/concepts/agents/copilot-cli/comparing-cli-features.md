---
source_path: "/en/copilot/concepts/agents/copilot-cli/comparing-cli-features"
title: "Comparing GitHub Copilot CLI customization features"
intro: "Find out about the various ways you can customize Copilot: what they do, and when to use them."
...
breadcrumbs:
  ...
  - title: "Comparing CLI features"
    href: "/en/copilot/concepts/agents/copilot-cli/comparing-cli-features"
---
...
See [Adding custom instructions for GitHub Copilot CLI](/en/copilot/how-tos/copilot-cli/customize-copilot/add-custom-instructions).
...
See [About GitHub Copilot CLI](/en/copilot/concepts/agents/copilot-cli/about-copilot-cli#allowed-tools).
