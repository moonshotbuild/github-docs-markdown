---
source_path: "/en/copilot/concepts/agents/copilot-cli/about-copilot-cli"
title: "About GitHub Copilot CLI"
intro: "Find out about using Copilot from the command line."
...
breadcrumbs:
  ...
  - title: "About Copilot CLI"
    href: "/en/copilot/concepts/agents/copilot-cli/about-copilot-cli"
---
...
For more information about these policies, see [MCP server usage in your company](/en/copilot/concepts/enterprise/mcp-management#mcp-allowlists).
