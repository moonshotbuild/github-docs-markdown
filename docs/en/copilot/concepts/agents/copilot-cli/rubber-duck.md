---
source_path: "/en/copilot/concepts/agents/copilot-cli/rubber-duck"
title: "About the rubber duck agent"
intro: "The rubber duck agent is a built-in critic that gives Copilot a constructive second opinion on its own plans, code, and tests—using a different AI model from the one driving your session."
...
breadcrumbs:
  ...
  - title: "About rubber duck"
    href: "/en/copilot/concepts/agents/copilot-cli/rubber-duck"
---
