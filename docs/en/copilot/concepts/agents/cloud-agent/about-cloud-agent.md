---
source_path: "/en/copilot/concepts/agents/cloud-agent/about-cloud-agent"
title: "About GitHub Copilot cloud agent"
intro: "Copilot can research a repository, create an implementation plan, and make code changes on a branch. You can review the diff, iterate, and create a pull request when you're ready."
...
breadcrumbs:
  ...
  - title: "About cloud agent"
    href: "/en/copilot/concepts/agents/cloud-agent/about-cloud-agent"
---
