---
source_path: "/en/copilot/tutorials/budgets/optimizing-your-budget-configuration"
...
breadcrumbs:
  ...
  - title: "Set up budgets"
    href: "/en/copilot/tutorials/budgets"
  - title: "Optimize budget configuration"
    href: "/en/copilot/tutorials/budgets/optimizing-your-budget-configuration"
---
...
Before optimizing your budget configuration, make sure you understand how budget controls work and how the system evaluates them. See [Budgets for usage-based billing](/en/copilot/concepts/billing/budgets-for-usage-based-billing).

If you haven't set up budgets yet, start with [Getting started with budget controls](/en/copilot/tutorials/budgets/getting-started-with-budget-controls) to get the basics in place, then come back to this guide to optimize your configuration.

To decide between a simple setup and cost-center-based controls before you fine-tune, see the basic and advanced approaches in [Controlling and tracking costs at scale](/en/billing/tutorials/control-costs-at-scale#choose-your-approach-basic-or-advanced-spend-controls).
...
2. Calculate your pool value: multiply your Copilot Business seats by $19 USD and your Copilot Enterprise seats by $39 USD, then add them together.
3. Subtract the pool value from the maximum total consumption. The result is the maximum metered charges your budgets need to cover.
...
If you want each cost center to stay within the AI credits its own licenses fund, apply an included usage control to that cost center. This automatically caps the team's draw from the shared pool, so heavy use by one team doesn't consume another team's share before metered budgets apply. See [Budgets for usage-based billing](/en/copilot/concepts/billing/budgets-for-usage-based-billing#included-usage-controls-for-cost-centers).
...
2. Set cost center budgets matching your desired spending caps.
3. Remove the organization budgets once cost center budgets are in place.
...
* Create **cost centers** scoped to each organization. See [Using cost centers to allocate costs to business units](/en/billing/how-tos/products/use-cost-centers).
...
* Create **cost centers** for each department and assign users directly. See [Using cost centers to allocate costs to business units](/en/billing/how-tos/products/use-cost-centers).
