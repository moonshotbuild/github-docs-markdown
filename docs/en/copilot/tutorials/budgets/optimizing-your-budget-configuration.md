...
To decide between managing cost centers using the user interface or the REST API see [Controlling and tracking costs at scale](/en/billing/tutorials/control-costs-at-scale).
