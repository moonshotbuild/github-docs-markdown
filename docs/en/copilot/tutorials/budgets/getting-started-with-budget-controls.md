---
source_path: "/en/copilot/tutorials/budgets/getting-started-with-budget-controls"
title: "Getting started with budget controls"
intro: "Set up budget guardrails for your enterprise before your team starts consuming AI credits."
...
breadcrumbs:
  ...
  - title: "Get started with budgets"
    href: "/en/copilot/tutorials/budgets/getting-started-with-budget-controls"
---
...
For step-by-step instructions, see [Setting up budgets to control spending on metered products](/en/billing/how-tos/set-up-budgets#creating-a-budget).
...
See [Sizing your spending limits](/en/copilot/tutorials/budgets/optimizing-your-budget-configuration#sizing-your-budgets) for guidance on calculating the right amount for your enterprise.
...
* To go deeper on budget configuration for your organization's structure, see [Optimizing your budget configuration](/en/copilot/tutorials/budgets/optimizing-your-budget-configuration).
