---
source_path: "/en/copilot/tutorials/use-an-ai-sme"
title: "Using Copilot CLI as your AI SME"
intro: "Use Copilot CLI as an always-available subject matter expert to learn how a codebase works, so you can confidently maintain it or add new features."
...
breadcrumbs:
  ...
  - title: "Use an AI SME"
    href: "/en/copilot/tutorials/use-an-ai-sme"
---
...
> \[!TIP]
>
> * If you trust Copilot CLI to run commands without prompting for approval, while blocking file changes, start with `copilot --deny-tool='write' --allow-all-tools`. See [Allowing and denying tool use](/en/copilot/how-tos/copilot-cli/use-copilot-cli/allowing-tools).
...
You can put this kind of preamble in a custom instructions file and reuse it across sessions, so you don't have to retype it each time. See [Adding custom instructions for GitHub Copilot CLI](/en/copilot/how-tos/copilot-cli/customize-copilot/add-custom-instructions).
