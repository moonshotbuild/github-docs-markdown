---
source_path: "/en/copilot/tutorials/migrate-a-project"
title: "Using GitHub Copilot to migrate a project to another programming language"
intro: "GitHub Copilot Chat can help you move a project to a different language. This guide describes what's involved in a migration process and gives an example of a PHP to Python migration."
...
breadcrumbs:
  ...
  - title: "Migrate a project"
    href: "/en/copilot/tutorials/migrate-a-project"
---
...
* **Use AI to help you**
  ...
  If you don't understand a particular part of the code you are about to translate, use Copilot's "explain" feature, either on the whole file, or a selected portion of the code within a file. See [Asking GitHub Copilot questions in your IDE](/en/copilot/how-tos/chat-with-copilot/chat-in-ide).
...
1. In your editor, open the Copilot Chat panel. See [Asking GitHub Copilot questions in your IDE](/en/copilot/how-tos/chat-with-copilot/chat-in-ide).
...
6. After you've completed the initial conversion, use Copilot to help you refactor the code in the new language. For more information, see [Refactoring code with GitHub Copilot](/en/copilot/tutorials/refactor-code).
