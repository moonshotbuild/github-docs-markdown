---
source_path: "/en/copilot/tutorials/review-ai-generated-code"
title: "Review AI-generated code"
intro: "Learn techniques to verify and validate AI-generated code, and how Copilot Chat can help."
...
breadcrumbs:
  ...
  - title: "Review AI code"
    href: "/en/copilot/tutorials/review-ai-generated-code"
---
...
* Try [Synthesizing research](/en/copilot/tutorials/copilot-cookbook/communicate-effectively/synthesizing-research) to see how Copilot uses documentation and research to inform code generation.
...
* Check [Improving code readability and maintainability](/en/copilot/tutorials/copilot-cookbook/refactor-code/improve-code-readability) for prompts and tips on reviewing and refactoring generated code.
...
* [Creating templates](/en/copilot/tutorials/copilot-cookbook/communicate-effectively/creating-templates) demonstrates how Copilot can assist with dependency setup, however it is good practice to always verify suggested packages yourself.
...
* See [Debugging invalid JSON](/en/copilot/tutorials/copilot-cookbook/debug-errors/debug-invalid-json) as an example of catching subtle errors and debugging with Copilot.
...
* See [Communicate effectively](/en/copilot/tutorials/copilot-cookbook/communicate-effectively) for examples of how to work with Copilot collaboratively and document findings.
...
* Reference [GitHub Copilot Cookbook](/en/copilot/tutorials/copilot-cookbook) for inspiration and share useful recipes in your team docs.
