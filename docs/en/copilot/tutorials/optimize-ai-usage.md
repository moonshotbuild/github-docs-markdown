---
source_path: "/en/copilot/tutorials/optimize-ai-usage"
title: "Optimizing your AI usage to maximize efficiency and reduce cost"
intro: "Learn how to choose the right models, structure your prompts, and add guardrails so that Copilot completes tasks more efficiently and uses fewer AI credits."
...
breadcrumbs:
  ...
  - title: "Optimize AI usage"
    href: "/en/copilot/tutorials/optimize-ai-usage"
---
...
See [Supported AI models in GitHub Copilot](/en/copilot/reference/ai-models/supported-models#models-with-extended-capabilities).
...
For information on the feature and its availability, see [About Copilot auto model selection](/en/copilot/concepts/models/auto-model-selection#copilot-chat-in-ides).
...
For prompt engineering best practices, see [Prompt engineering for GitHub Copilot Chat](/en/copilot/concepts/prompting/prompt-engineering).
...
See [Managing context in GitHub Copilot CLI](/en/copilot/concepts/agents/copilot-cli/context-management).

### Give Copilot a map of your project

A well-maintained custom instructions file, such as an `AGENTS.md` or `.github/copilot-instructions.md` file, gives agents a structural overview of your repository so they don't have to read large numbers of files just to orient themselves. See [Support for different types of custom instructions](/en/copilot/reference/custom-instructions-support).
...
See [Configuring toolsets for the GitHub MCP Server](/en/copilot/how-tos/provide-context/use-mcp-in-your-ide/configure-toolsets).

## 4. Preserve the cache

Caching lets an AI model store portions of a conversation's context so they don't need to be reprocessed on every request. In agentic coding, where the same large context—system prompt, file contents, tool definitions—is sent repeatedly across many turns, caching has an impact: the cached portion from the previous response is reused rather than reprocessed, and cached tokens are typically billed at 10% of the normal input price. See [Models and pricing for GitHub Copilot](/en/copilot/reference/copilot-billing/models-and-pricing).
...
Starting a new session between phases prevents you from carrying unnecessary context forward, which can increase token usage and reduce clarity for the agent. Each phase should operate with only what it needs. For guidance on scoping sessions effectively, see [Best practices for using GitHub Copilot to work on tasks](/en/copilot/tutorials/cloud-agent/get-the-best-results).
...
* **Use your dashboard and budget controls**. The "AI usage" page, under <https://github.com/settings/billing>, breaks down consumption across every feature and model, so you can see where your credits are actually going and adjust accordingly. See [Monitoring your GitHub AI Credits usage](/en/copilot/how-tos/manage-and-track-spending/monitor-ai-usage).
* **Upgrade for a larger allowance**. If you regularly approach your monthly limit, a higher plan may be more economical than paying for additional usage, as higher plans have more AI credit allowance. See [About individual GitHub Copilot plans and benefits](/en/copilot/concepts/billing/individual-plans#github-ai-credits-allowance-by-plan) and [Viewing and changing your GitHub Copilot plan](/en/copilot/how-tos/manage-your-account/view-and-change-your-copilot-plan).
