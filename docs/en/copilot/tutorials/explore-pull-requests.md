---
source_path: "/en/copilot/tutorials/explore-pull-requests"
title: "Using GitHub Copilot to explore pull requests"
intro: "GitHub Copilot Chat can help you understand the content, functionality, and status of a pull request."
...
breadcrumbs:
  ...
  - title: "Explore pull requests"
    href: "/en/copilot/tutorials/explore-pull-requests"
---
...
1. On GitHub, navigate to a pull request in a repository.
2. Open Copilot Chat, type your question, and press <kbd>Enter</kbd>.
