---
source_path: "/en/copilot/tutorials/customize-code-review"
title: "Using custom instructions to unlock the power of Copilot code review"
intro: "Learn how to write effective custom instructions that help GitHub Copilot provide more relevant and actionable code reviews."
...
breadcrumbs:
  ...
  - title: "Customize code review"
    href: "/en/copilot/tutorials/customize-code-review"
---
...
This tutorial is about using custom instructions for Copilot code review. For a more general introduction to using custom instructions, see [Add custom instructions for Copilot](/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions).
...
3. **`AGENTS.md`**: Repository-level agent-specific instructions.
...
* Explore [Add custom instructions for Copilot](/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions) for technical details on setting up instruction files.
