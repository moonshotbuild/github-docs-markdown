---
source_path: "/en/copilot/tutorials/use-copilot-code-review-across-the-pull-request-lifecycle"
title: "Use GitHub Copilot code review across the pull request lifecycle"
intro: "Build a repeatable workflow for Copilot code review from draft pull request to merge."
...
breadcrumbs:
  ...
  - title: "Pull request lifecycle"
    href: "/en/copilot/tutorials/use-copilot-code-review-across-the-pull-request-lifecycle"
---
...
For setup steps, see [Using GitHub Copilot code review](/en/copilot/how-tos/use-copilot-agents/request-a-code-review/use-code-review) and [Configuring code review by GitHub Copilot](/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-code-review).
