---
source_path: "/en/copilot/tutorials/roll-out-at-scale/govern-at-scale/pilot-a-feature-or-model"
title: "Pilot a new Copilot feature or model in your enterprise"
intro: "Pilot a new Copilot feature or model to validate adoption, control costs, and gather evidence for a wider rollout."
...
breadcrumbs:
  ...
  - title: "Govern at scale"
    href: "/en/copilot/tutorials/roll-out-at-scale/govern-at-scale"
  - title: "Pilot a feature or model"
    href: "/en/copilot/tutorials/roll-out-at-scale/govern-at-scale/pilot-a-feature-or-model"
---
...
Before you enable anything, make sure you've evaluated the feature or model and confirmed it meets your compliance requirements. See [Learning about new features and models](/en/copilot/concepts/enterprise/learning-about-new-features-and-models).
...
Start by understanding how the feature or model is billed. Usage-based features consume GitHub AI Credits, and the cost of each interaction depends on the model and the number of tokens consumed. To understand which features count toward usage, how included credits are pooled across your enterprise, and how overages are charged, see [Usage-based billing for organizations and enterprises](/en/copilot/concepts/billing/organizations-and-enterprises/usage-based-billing).
