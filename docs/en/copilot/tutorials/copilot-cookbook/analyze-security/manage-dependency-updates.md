---
source_path: "/en/copilot/tutorials/copilot-cookbook/analyze-security/manage-dependency-updates"
title: "Managing dependency updates"
intro: "Copilot Chat can help you get set up with Dependabot to streamline dependency updates."
...
breadcrumbs:
  ...
  - title: "Manage dependency updates"
    href: "/en/copilot/tutorials/copilot-cookbook/analyze-security/manage-dependency-updates"
---
...
Copilot Chat can help you get set up with Dependabot security and version updates, so that your dependencies always remain on the most secure, and up-to-date versions. See [Dependabot security updates](/en/code-security/concepts/supply-chain-security/dependabot-security-updates) and [Dependabot version updates](/en/code-security/concepts/supply-chain-security/dependabot-version-updates).
...
> \[!TIP]
>
> * There are many customization options to explore. For more information, see [Customizing pull requests for Dependabot security updates](/en/code-security/how-tos/secure-your-supply-chain/manage-your-dependency-security/customizing-dependabot-security-prs) and [Customizing Dependabot pull requests to fit your processes](/en/code-security/tutorials/secure-your-dependencies/customizing-dependabot-prs).
