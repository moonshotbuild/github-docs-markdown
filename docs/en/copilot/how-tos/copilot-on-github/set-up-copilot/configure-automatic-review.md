...
Balanced reviews use more AI credits, and may consume marginally more GitHub Actions minutes. For more information on the cost of review effort levels, see [About GitHub Copilot code review](/en/copilot/concepts/agents/code-review#estimated-consumption).
