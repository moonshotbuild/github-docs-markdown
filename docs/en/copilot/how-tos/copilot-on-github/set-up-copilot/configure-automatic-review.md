---
source_path: "/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-automatic-review"
title: "Configuring automatic code review by GitHub Copilot"
intro: "Set up Copilot to automatically review pull requests for you, a repository, or an organization."
...
breadcrumbs:
  ...
  - title: "Configure automatic review"
    href: "/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-automatic-review"
---
...
You can configure Copilot code review to review pull requests automatically. For an overview of automatic pull request reviews, see [About GitHub Copilot code review](/en/copilot/concepts/agents/code-review#about-automatic-pull-request-reviews).
...
You can set the default review effort level that Copilot code review uses for automatic reviews at both the organization and repository levels. Repository settings override organization defaults. For an overview of review effort levels, see [About GitHub Copilot code review](/en/copilot/concepts/agents/code-review#review-effort-level).
...
5. Next to "Review effort level," select the default effort level for automatic reviews in repositories in your organization.
   * **Lite**: Standard review (default).
   * **Balanced**: Deeper analysis of complex logic, security-sensitive code, and cross-service changes.

Balanced reviews use more GitHub Actions minutes and AI credits. If you use Balanced effort, consider configuring larger or self-hosted runners for better performance. See [Configuring runners for GitHub Copilot code review](/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-runners).
...
4. Next to "Review effort level," select the effort level for automatic reviews in this repository.
   * **Lite**: Standard review (default).
   * **Balanced**: Deeper analysis of complex logic, security-sensitive code, and cross-service changes.
