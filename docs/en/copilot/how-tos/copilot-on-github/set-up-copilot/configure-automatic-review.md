...
You can set the default review effort level that Copilot code review uses for automatic reviews in a repository. For an overview of review effort levels, see [About GitHub Copilot code review](/en/copilot/concepts/agents/code-review#review-effort-level).
...
Medium reviews use more GitHub Actions minutes and AI credits. If you use Medium effort, consider configuring larger or self-hosted runners for better performance. See [Configuring runners for GitHub Copilot code review](/en/copilot/how-tos/copilot-on-github/set-up-copilot/configure-runners).
