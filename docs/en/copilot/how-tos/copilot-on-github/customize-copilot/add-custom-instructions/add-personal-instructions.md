---
source_path: "/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions/add-personal-instructions"
title: "Adding personal custom instructions for GitHub Copilot"
intro: "Customize GitHub Copilot Chat responses to match your personal preferences."
...
breadcrumbs:
  ...
  - title: "Add custom instructions"
    href: "/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions"
  - title: "Add personal instructions"
    href: "/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions/add-personal-instructions"
---
...
You can layer multiple types of custom instructions to shape GitHub Copilot Chat responses. For an overview, see [About customizing GitHub Copilot responses](/en/copilot/concepts/prompting/response-customization?tool=webui).
