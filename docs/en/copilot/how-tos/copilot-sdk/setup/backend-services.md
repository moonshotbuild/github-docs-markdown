---
source_path: "/en/copilot/how-tos/copilot-sdk/setup/backend-services"
title: "Backend services setup"
intro: "Run the Copilot SDK in server-side applications—APIs, web backends, microservices, and background workers. The CLI runs as a headless server that your backend code connects to over the network."
...
breadcrumbs:
  ...
  - title: "Backend Services"
    href: "/en/copilot/how-tos/copilot-sdk/setup/backend-services"
---
...
For multi-user server mode, configure SDK clients with `mode: "empty"`, pass user credentials per session, and explicitly allow tools for each session. See [Multi-tenancy and server deployments](/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) for the full pattern.
...
Pass individual user tokens when creating sessions. See [GitHub OAuth setup](/en/copilot/how-tos/copilot-sdk/setup/github-oauth) for the full flow.
...
Use your own API keys for the model provider. See [BYOK (bring your own key)](/en/copilot/how-tos/copilot-sdk/auth/byok) for details.
...
| Limitation                                      | Details                                                                                        |
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| **Single CLI server = single point of failure** | See [Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling) for HA patterns |
...
| Need                                     | Next Guide                                                                                  |
| ---------------------------------------- | ------------------------------------------------------------------------------------------- |
| Multiple CLI servers / high availability | [Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling)                  |
| SDK isolation for concurrent users       | [Multi-tenancy and server deployments](/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy) |
| GitHub account auth for users            | [GitHub OAuth setup](/en/copilot/how-tos/copilot-sdk/setup/github-oauth)                    |
| Your own model keys                      | [BYOK (bring your own key)](/en/copilot/how-tos/copilot-sdk/auth/byok)                      |

## Next steps

* **[Multi-tenancy and server deployments](/en/copilot/how-tos/copilot-sdk/setup/multi-tenancy)**: Configure SDK isolation for concurrent users
* **[Scaling and multi-tenancy](/en/copilot/how-tos/copilot-sdk/setup/scaling)**: Handle more users, add redundancy
* **[Session resume and persistence](/en/copilot/how-tos/copilot-sdk/features/session-persistence)**: Resume sessions across restarts
* **[GitHub OAuth setup](/en/copilot/how-tos/copilot-sdk/setup/github-oauth)**: Add user authentication
