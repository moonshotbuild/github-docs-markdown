---
source_path: "/en/copilot/how-tos/copilot-sdk/features/steering-and-queueing"
title: "Steering and queueing"
intro: "Two interaction patterns let users send messages while the agent is already working: steering redirects the agent mid-turn, and queueing buffers messages for sequential processing after the current turn completes."
...
breadcrumbs:
  ...
  - title: "Steering And Queueing"
    href: "/en/copilot/how-tos/copilot-sdk/features/steering-and-queueing"
---
...
* [Build your first Copilot-powered app](/en/copilot/how-tos/copilot-sdk/getting-started): Set up a session and send messages
* [Custom agents and sub-agent orchestration](/en/copilot/how-tos/copilot-sdk/features/custom-agents): Define specialized agents with scoped tools
* [Session hooks](/en/copilot/how-tos/copilot-sdk/hooks/hooks-overview): React to session lifecycle events
