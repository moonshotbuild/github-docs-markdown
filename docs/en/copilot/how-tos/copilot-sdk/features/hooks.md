---
source_path: "/en/copilot/how-tos/copilot-sdk/features/hooks"
title: "Working with hooks"
intro: "Hooks let you plug custom logic into every stage of a Copilot session—from the moment it starts, through each user prompt and tool call, to the moment it ends. This guide walks through practical use cases so you can ship permissions, auditing, notifications, and more without modifying the core agent behavior."
...
breadcrumbs:
  ...
  - title: "Hooks"
    href: "/en/copilot/how-tos/copilot-sdk/features/hooks"
---
