...
3. When you're prompted to choose a voice model, press <kbd>Enter</kbd> with "Download default model" selected to download the default multilingual speech-to-text model.
   ...
   2. In the voice models picker, use the arrow keys to select the model you want, then press <kbd>Enter</kbd> to download it.
...
2. In the voice models picker, use the arrow keys on your keyboard to select the model you want to use, then press <kbd>Enter</kbd>.
