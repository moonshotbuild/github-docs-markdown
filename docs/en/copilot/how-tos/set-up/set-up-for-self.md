---
source_path: "/en/copilot/how-tos/set-up/set-up-for-self"
...
breadcrumbs:
  ...
  - title: "Set up for self"
    href: "/en/copilot/how-tos/set-up/set-up-for-self"
---
...
* **Use Copilot Free**. Get a limited experience of Copilot with up to 2,000 inline suggestion requests and limited chat and agent usage-no paid plan required. See [Plans for GitHub Copilot](/en/copilot/get-started/plans).
...
To get started with agent-driven development in the GitHub Copilot app, see [Getting started with the GitHub Copilot app](/en/copilot/get-started/quickstart-copilot-app).
