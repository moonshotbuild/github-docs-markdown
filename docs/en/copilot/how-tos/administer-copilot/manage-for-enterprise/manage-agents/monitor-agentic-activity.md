---
source_path: "/en/copilot/how-tos/administer-copilot/manage-for-enterprise/manage-agents/monitor-agentic-activity"
...
breadcrumbs:
  ...
  - title: "Monitor agentic activity"
    href: "/en/copilot/how-tos/administer-copilot/manage-for-enterprise/manage-agents/monitor-agentic-activity"
---
...
4. To filter agent sessions, click the search bar at the top of the list, then press <kbd>Space</kbd>. From the dropdown menu that appears, select your filter criteria. For a list of available filters, see [Available filters for agent sessions](/en/copilot/reference/enterprise-administrators/agent-session-filters).
...
For more information, see [OpenTelemetry for agent monitoring](/en/copilot/concepts/enterprise/opentelemetry).
