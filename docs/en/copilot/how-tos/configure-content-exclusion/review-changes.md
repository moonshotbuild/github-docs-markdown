---
source_path: "/en/copilot/how-tos/configure-content-exclusion/review-changes"
...
breadcrumbs:
  ...
  - title: "Review changes"
    href: "/en/copilot/how-tos/configure-content-exclusion/review-changes"
---
...
6. Click the ellipsis (...) at the end of each entry to see more details.
   ...
   ![Screenshot of audit log details for the 'copilot.content\_exclusion\_changed' action. The ellipsis button is highlighted.](/assets/images/help/copilot/copilot-audit-log.png)
...
6. Click the time of the last change.
...
7. Click the ellipsis (...) at the end of each entry to see more details.
