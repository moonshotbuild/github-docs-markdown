---
source_path: "/en/billing/reference/cost-center-allocation"
...
breadcrumbs:
  ...
  - title: "Cost center allocation"
    href: "/en/billing/reference/cost-center-allocation"
---
...
See [About billing for GitHub Copilot in organizations and enterprises](/en/copilot/concepts/billing/organizations-and-enterprises#seat-assignment).
...
To understand how usage for a specific resource is being attributed to cost centers, request a detailed usage report and refer to the `cost_center_name` column. See [Billing reports reference](/en/billing/reference/billing-reports).
