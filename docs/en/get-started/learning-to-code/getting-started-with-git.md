---
source_path: "/en/get-started/learning-to-code/getting-started-with-git"
...
5. Install GitHub Copilot CLI, so that you can use Copilot from the command line. See [Installing GitHub Copilot CLI](/en/copilot/how-tos/copilot-cli/set-up-copilot-cli/install-copilot-cli).
