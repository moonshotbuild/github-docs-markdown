---
source_path: "/en/get-started/learning-about-github/githubs-plans"
title: "GitHub's plans"
intro: "An overview of GitHub's pricing plans."
product: "Get started"
...
* 50,000 GitHub Actions minutes per month
  * Included minutes can be used with standard GitHub-hosted runners only. For more information about billing for larger runners, see [Larger runners](/en/enterprise-cloud@latest/actions/concepts/runners/larger-runners#understanding-billing).
* 50 GB GitHub Packages storage
* A service level agreement for 99.9% monthly uptime
* The option to centrally manage policy and billing for multiple GitHub organizations with an enterprise account. For more information, see [Enterprise accounts](/en/enterprise-cloud@latest/admin/concepts/enterprise-fundamentals/enterprise-accounts).
...
* The option to provision and manage the user accounts for your developers, by using Enterprise Managed Users. For more information, see [About Enterprise Managed Users](/en/enterprise-cloud@latest/admin/concepts/identity-and-access-management/enterprise-managed-users).
