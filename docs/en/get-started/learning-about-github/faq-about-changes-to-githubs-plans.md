---
source_path: "/en/get-started/learning-about-github/faq-about-changes-to-githubs-plans"
...
To upgrade your account's plan, see [Upgrading your account's plan](/en/billing/how-tos/manage-plan-and-licenses/upgrade-plan).

## How can I downgrade my plan?

To downgrade your personal account or organization's plan, see [Downgrading your account's plan](/en/billing/how-tos/manage-plan-and-licenses/downgrade-plan).
...
Most small teams use fewer than 3,000 Actions minutes/month, but some teams might use more. If your team needs additional minutes for private repositories, you can increase your spending limit for GitHub Actions. Actions minutes and Packages storage are still free for your public repositories. For more information, see [Setting up budgets to control spending on metered products](/en/billing/how-tos/set-up-budgets).

## How do the seat limit changes affect me?

Now that GitHub Team has no minimum seat requirement, if you are using fewer than five seats in your organization, you can remove paid seats to reduce your bill. For more information, see [Downgrading your account's plan](/en/billing/how-tos/manage-plan-and-licenses/downgrade-plan#removing-paid-seats-from-your-organization).
