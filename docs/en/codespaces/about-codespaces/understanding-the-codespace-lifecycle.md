---
source_path: "/en/codespaces/about-codespaces/understanding-the-codespace-lifecycle"
title: "Understanding the codespace lifecycle"
intro: "Learn how to develop in a GitHub Codespaces environment, and maintain your data throughout the entire codespace lifecycle."
product: "Codespaces"
...
breadcrumbs:
  ...
  - title: "The codespace lifecycle"
    href: "/en/codespaces/about-codespaces/understanding-the-codespace-lifecycle"
---
...
If you create a codespace, it will continue to accrue storage charges until it is deleted, irrespective of whether it is active or stopped. For more information, see [GitHub Codespaces billing](/en/billing/concepts/product-billing/github-codespaces). Deleting a codespace does not reduce the current billable amount for GitHub Codespaces, which accumulates during each monthly billing cycle. For more information, see [Viewing your usage of metered products and licenses](/en/billing/how-tos/products/view-productlicense-use).
