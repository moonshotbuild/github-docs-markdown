---
source_path: "/en/codespaces/about-codespaces/what-are-codespaces"
title: "What are GitHub Codespaces?"
intro: "Learn about what GitHub Codespaces are."
product: "Codespaces"
...
breadcrumbs:
  ...
  - title: "Getting started"
    href: "/en/codespaces/about-codespaces"
  - title: "What are Codespaces?"
    href: "/en/codespaces/about-codespaces/what-are-codespaces"
---
...
Owners of organizations on GitHub Team and GitHub Enterprise plans can pay for their members' and collaborators' use of GitHub Codespaces. This applies to codespaces created from repositories owned by the organization. See [Choosing who owns and pays for codespaces in your organization](/en/codespaces/managing-codespaces-for-your-organization/choosing-who-owns-and-pays-for-codespaces-in-your-organization). You can set a spending limit for use of GitHub Codespaces on your organization or enterprise account. See [Setting up budgets to control spending on metered products](/en/billing/how-tos/set-up-budgets).
...
For information on pricing, storage, and usage for GitHub Codespaces, see [GitHub Codespaces billing](/en/billing/concepts/product-billing/github-codespaces).
...
Costs for GitHub Codespaces are always billed monthly, even if your account is otherwise billed annually. For information on how organizations owners and billing managers can manage the spending limit for GitHub Codespaces for an organization, see [Setting up budgets to control spending on metered products](/en/billing/how-tos/set-up-budgets).
