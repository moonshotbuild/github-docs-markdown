---
source_path: "/en/actions/tutorials/create-actions/create-a-javascript-action"
...
breadcrumbs:
  ...
  - title: "Create a JavaScript action"
    href: "/en/actions/tutorials/create-actions/create-a-javascript-action"
---
...
Create a new file named `action.yml` in the `hello-world-javascript-action` directory with the following example code. For more information, see [Metadata syntax reference](/en/actions/reference/workflows-and-actions/metadata-syntax).
...
If an error is thrown in the above `index.js` example, `core.setFailed(error.message);` uses the actions toolkit [`@actions/core`](https://github.com/actions/toolkit/tree/main/packages/core) package to log a message and set a failing exit code. For more information, see [Setting exit codes for actions](/en/actions/how-tos/create-and-publish-actions/set-exit-codes).
