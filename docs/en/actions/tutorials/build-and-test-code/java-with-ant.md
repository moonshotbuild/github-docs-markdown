---
source_path: "/en/actions/tutorials/build-and-test-code/java-with-ant"
...
breadcrumbs:
  ...
  - title: "Java with Ant"
    href: "/en/actions/tutorials/build-and-test-code/java-with-ant"
---
...
GitHub-hosted runners have a tools cache with pre-installed software, which includes Java Development Kits (JDKs) and Ant. For a list of software and the pre-installed versions for JDK and Ant, see [GitHub-hosted runners](/en/actions/concepts/runners/github-hosted-runners#supported-software).
