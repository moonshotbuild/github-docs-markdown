---
source_path: "/en/actions/get-started/continuous-deployment"
title: "Continuous deployment"
intro: "You can create custom continuous deployment (CD) workflows directly in your GitHub repository with GitHub Actions."
...
breadcrumbs:
  ...
  - title: "Continuous deployment"
    href: "/en/actions/get-started/continuous-deployment"
---
...
Continuous deployment is often coupled with continuous integration. For more information about continuous integration, see [Continuous integration](/en/actions/get-started/continuous-integration).
