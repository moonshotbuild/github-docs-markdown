---
source_path: "/en/actions/concepts/workflows-and-actions/reusing-workflow-configurations"
...
breadcrumbs:
  ...
  - title: "Reusing workflow configurations"
    href: "/en/actions/concepts/workflows-and-actions/reusing-workflow-configurations"
---
...
You can view the reused workflows referenced in your GitHub Actions workflows as dependencies in the dependency graph of the repository containing your workflows. For more information, see “[About the dependency graph](/en/code-security/concepts/supply-chain-security/dependency-graph).”
...
* **Deployment (CD)**. For more information, see [Continuous deployment](/en/actions/get-started/continuous-deployment).
* **Security**. For more information, see [Configuring advanced setup for code scanning](/en/code-security/how-tos/find-and-fix-code-vulnerabilities/configure-code-scanning/configuring-advanced-setup-for-code-scanning#configuring-code-scanning-using-third-party-actions).
* **Continuous Integration (CI)**. For more information, see [Continuous integration](/en/actions/get-started/continuous-integration).
...
To start reusing your workflows, see [Reuse workflows](/en/actions/how-tos/reuse-automations/reuse-workflows).
