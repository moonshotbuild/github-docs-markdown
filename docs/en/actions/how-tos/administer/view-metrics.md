---
source_path: "/en/actions/how-tos/administer/view-metrics"
title: "Viewing GitHub Actions metrics"
intro: "You can view metrics to monitor where your organization or repositories use GitHub Actions and how they are performing."
...
breadcrumbs:
  ...
  - title: "View metrics"
    href: "/en/actions/how-tos/administer/view-metrics"
---
...
4. Optionally, to select a time period to view usage metrics for, choose an option from the **Period** drop down menu at the top right of the page. For more information, see [Viewing GitHub Actions metrics](/en/actions/how-tos/administer/view-metrics#understanding-github-actions-metrics-aggregation).
5. Click on the tab that contains the metrics you would like to view. For more information, see [About GitHub Actions metrics](/en/actions/concepts/metrics).
