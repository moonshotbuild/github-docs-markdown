---
source_path: "/en/actions/how-tos/monitor-workflows/use-workflow-run-logs"
...
breadcrumbs:
  ...
  - title: "Use workflow run logs"
    href: "/en/actions/how-tos/monitor-workflows/use-workflow-run-logs"
---
...
You can download the log files from your workflow run. You can also download a workflow's artifacts. For more information, see [Store and share data with workflow artifacts](/en/actions/tutorials/store-and-share-data). Read access to the repository is required to perform these steps.
