...
* For security hardening, make sure you've reviewed [Configuring the OIDC trust with the cloud](/en/actions/concepts/security/openid-connect#configuring-the-oidc-trust-with-the-cloud). For an example, see [Configuring the subject in your cloud provider](/en/actions/concepts/security/openid-connect#configuring-the-subject-in-your-cloud-provider).
