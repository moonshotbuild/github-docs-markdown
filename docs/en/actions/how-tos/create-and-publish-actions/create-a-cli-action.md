---
source_path: "/en/actions/how-tos/create-and-publish-actions/create-a-cli-action"
title: "Creating a third party CLI action"
intro: "Learn how to develop an action to set up a CLI on GitHub Actions runners."
...
breadcrumbs:
  ...
  - title: "Create a CLI action"
    href: "/en/actions/how-tos/create-and-publish-actions/create-a-cli-action"
---
...
You should have an understanding of how to write a custom action. For more information, see [Managing custom actions](/en/actions/how-tos/create-and-publish-actions/manage-custom-actions).
...
To use this script, replace `getDownloadURL` with a function that downloads your CLI. You will also need to create an actions metadata file (`action.yml`) that accepts a `version` input and that runs this script. For full details about how to create an action, see [Creating a JavaScript action](/en/actions/tutorials/create-actions/create-a-javascript-action).
