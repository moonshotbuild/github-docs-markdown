---
source_path: "/en/repositories/working-with-files/managing-files/renaming-a-file"
title: "Renaming a file"
intro: "You can rename any file in your repository directly in GitHub or by using the command line."
...
breadcrumbs:
  ...
  - title: "Renaming a file"
    href: "/en/repositories/working-with-files/managing-files/renaming-a-file"
---
...
> \[!TIP]
>
> * If you try to rename a file in a repository that you don’t have access to, we will fork the project to your personal account and help you send [a pull request](/en/pull-requests/reference/pull-requests) to the original repository after you commit your change.
