---
source_path: "/en/repositories/working-with-files/using-files/getting-permanent-links-to-files"
title: "Getting permanent links to files"
intro: "When viewing a file on GitHub, you can press the \"y\" key to update the URL to a permalink to the exact version of the file you see."
...
breadcrumbs:
  ...
  - title: "Permanent links to files"
    href: "/en/repositories/working-with-files/using-files/getting-permanent-links-to-files"
---
