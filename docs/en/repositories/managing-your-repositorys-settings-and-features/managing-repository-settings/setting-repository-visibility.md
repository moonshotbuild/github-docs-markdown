...
* GitHub will detach private forks and turn them into a standalone private repository. For more information, see [Forks](/en/pull-requests/reference/forks#what-happens-to-forks-when-a-repository-is-deleted-or-changes-visibility)
