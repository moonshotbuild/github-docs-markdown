---
source_path: "/en/repositories/creating-and-managing-repositories/deleting-a-repository"
...
breadcrumbs:
  ...
  - title: "Deleting a repository"
    href: "/en/repositories/creating-and-managing-repositories/deleting-a-repository"
---
...
Only members with owner privileges for an organization or admin privileges for a repository can delete an organization repository, and these users may be prevented from deleting a repository by an organization or enterprise policy. For more information, see [Repository roles for an organization](/en/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/repository-roles-for-an-organization).
...
Some deleted repositories can be restored within 90 days of deletion. For more information, see [Restoring a deleted repository](/en/repositories/creating-and-managing-repositories/restoring-a-deleted-repository).
