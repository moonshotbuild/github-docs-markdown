---
source_path: "/en/search-github/searching-on-github/searching-code"
title: "Searching code (legacy)"
intro: "You only need to use the legacy code search syntax if you are using the code search API."
...
breadcrumbs:
  ...
  - title: "Searching code (legacy)"
    href: "/en/search-github/searching-on-github/searching-code"
---
...
* Code in [forks](/en/pull-requests/reference/forks) is only searchable if the fork has more stars than the parent repository, and the forked repository has at least one pushed commit after being created. Forks with fewer stars than the parent repository or no commits are **not** indexed for code search. To include forks with more stars than their parent and at least one pushed commit in the search results, you will need to add `fork:true` or `fork:only` to your query. For more information, see [Searching in forks](/en/search-github/searching-on-github/searching-in-forks).
