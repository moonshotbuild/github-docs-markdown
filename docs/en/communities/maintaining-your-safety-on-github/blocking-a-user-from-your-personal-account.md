---
source_path: "/en/communities/maintaining-your-safety-on-github/blocking-a-user-from-your-personal-account"
...
breadcrumbs:
  ...
  - title: "Maintaining safety"
    href: "/en/communities/maintaining-your-safety-on-github"
  - title: "Block from your account"
    href: "/en/communities/maintaining-your-safety-on-github/blocking-a-user-from-your-personal-account"
---
...
3. Optionally, select **Close all open issues, pull requests, and discussions opened by this user**.
4. Optionally, add a note to describe why you blocked the user. The note will only be visible to you.
5. To confirm, click **Block user**.
...
3. Under "Block a user", type the username of the user you'd like to block.
4. Optionally, select **Close all open issues, pull requests, and discussions opened by this user**.
5. Click **Block user**.
6. Optionally, to add a note to describe why a user was blocked, click **Add Note**. The note will only be visible to you.
7. Optionally, you can display a warning when you visit a repository where a blocked user is a contributor. Under "Blocked users", select **Warn me when a blocked user is a prior contributor to a repository**.
...
3. Optionally, select **Close all issues, pull requests, and discussions opened by this user**.
4. Optionally, add a note to describe why a user was blocked. The note will only be visible to you.
5. Click **Block user**.
