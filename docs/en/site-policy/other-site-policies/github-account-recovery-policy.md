---
source_path: "/en/site-policy/other-site-policies/github-account-recovery-policy"
...
breadcrumbs:
  ...
  - title: "Other Site Policies"
    href: "/en/site-policy/other-site-policies"
  - title: "GitHub Account Recovery Policy"
    href: "/en/site-policy/other-site-policies/github-account-recovery-policy"
---
...
You can, however, [unlink email addresses](/en/account-and-profile/how-tos/account-management/unlinking-your-email-address-from-a-locked-account) from a locked account in order to create a new account or use the email on another existing account.
...
See [Unlinking your email address from a locked account](/en/account-and-profile/how-tos/account-management/unlinking-your-email-address-from-a-locked-account).
...
If you have lost access to a user account, you may [clone](/en/repositories/creating-and-managing-repositories/cloning-a-repository) or [fork](/en/pull-requests/how-tos/work-with-forks/fork-a-repo) any content that is public.
