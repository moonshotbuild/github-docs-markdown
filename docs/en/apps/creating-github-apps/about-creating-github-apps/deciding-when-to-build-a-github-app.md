---
source_path: "/en/apps/creating-github-apps/about-creating-github-apps/deciding-when-to-build-a-github-app"
title: "Deciding when to build a GitHub App"
intro: "When building an integration, you should consider using a GitHub App in the following scenarios, instead of an OAuth app, personal access token, or GitHub Actions."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "GitHub App versus other options"
    href: "/en/apps/creating-github-apps/about-creating-github-apps/deciding-when-to-build-a-github-app"
---
...
For information on how to migrate an existing OAuth app to a GitHub App, see [Migrating OAuth apps to GitHub Apps](/en/apps/creating-github-apps/about-creating-github-apps/migrating-oauth-apps-to-github-apps).
...
The rate limit for GitHub Apps using an installation access token scales with the number of repositories and number of organization users. Conversely, OAuth apps have lower rate limits and do not scale. For more information, see [Rate limits for GitHub Apps](/en/apps/creating-github-apps/registering-a-github-app/rate-limits-for-github-apps).
...
For more information about the REST API endpoints that are available to GitHub Apps, see [Endpoints available for GitHub App installation access tokens](/en/rest/authentication/endpoints-available-for-github-app-installation-access-tokens).
