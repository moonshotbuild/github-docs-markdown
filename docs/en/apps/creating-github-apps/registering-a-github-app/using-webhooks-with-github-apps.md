---
source_path: "/en/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps"
title: "Using webhooks with GitHub Apps"
intro: "Your GitHub App can subscribe to webhook events to receive notifications whenever certain activity occurs."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "Webhooks"
    href: "/en/apps/creating-github-apps/registering-a-github-app/using-webhooks-with-github-apps"
---
...
Webhooks enable your GitHub App to receive real-time notifications when events happen on GitHub, such as when someone pushes a commit or opens a pull request in a repository that your app can access. For more information about webhooks, see [About webhooks](/en/webhooks/about-webhooks). For a tutorial that demonstrates how to use webhooks with a GitHub App, see [Building a GitHub App that responds to webhook events](/en/apps/creating-github-apps/writing-code-for-a-github-app/building-a-github-app-that-responds-to-webhook-events).

You can configure your GitHub App to receive webhooks for specific events on GitHub and automatically take action on them. For more information about the types of webhooks you can receive, see [Webhook events and payloads](/en/webhooks/webhook-events-and-payloads).
...
After creating a webhook secret for your app, you will need to configure your server to securely store and validate the webhook secret token. For more information, see [Validating webhook deliveries](/en/webhooks/using-webhooks/validating-webhook-deliveries).
...
For more information about the permissions that are required for each webhook event, see [Webhook events and payloads](/en/webhooks/webhook-events-and-payloads).
