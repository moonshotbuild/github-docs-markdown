---
source_path: "/en/apps/oauth-apps/maintaining-oauth-apps/troubleshooting-oauth-app-access-token-request-errors"
title: "Troubleshooting OAuth app access token request errors"
intro: "When exchanging a code for an access token, there are an additional set of errors that can occur. The format of these responses is determined by the accept header you pass."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "Troubleshoot token request"
    href: "/en/apps/oauth-apps/maintaining-oauth-apps/troubleshooting-oauth-app-access-token-request-errors"
---
