---
source_path: "/en/apps/oauth-apps/maintaining-oauth-apps/transferring-ownership-of-an-oauth-app"
title: "Transferring ownership of an OAuth app"
intro: "You can transfer ownership of an OAuth app to another user or organization."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "Maintaining OAuth apps"
    href: "/en/apps/oauth-apps/maintaining-oauth-apps"
  - title: "Transfer ownership"
    href: "/en/apps/oauth-apps/maintaining-oauth-apps/transferring-ownership-of-an-oauth-app"
---
...
1. To confirm the transfer, in the text field, type the name of the OAuth app you want to transfer.
1. Under "New owner's GitHub username or organization name," type the name of the user or organization you want to transfer the OAuth app to.
