---
source_path: "/en/apps/oauth-apps/using-oauth-apps/connecting-with-third-party-applications"
title: "Connecting with third-party applications"
intro: "You can connect your GitHub identity to third-party applications using OAuth. When authorizing one of these applications, you should ensure you trust the application, review who it's developed by, and review the kinds of information the application wants to access."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "Third-party applications"
    href: "/en/apps/oauth-apps/using-oauth-apps/connecting-with-third-party-applications"
---
...
| Hooks                   | [Webhooks](/en/webhooks/about-webhooks) access allows applications to read or write hook configurations on repositories you manage.                                                                                                                                                                                                                                             |
