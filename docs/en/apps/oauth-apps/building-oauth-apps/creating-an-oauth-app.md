---
source_path: "/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app"
title: "Creating an OAuth app"
intro: "You can create and register an OAuth app under your personal account or under any organization you have administrative access to. While creating your OAuth app, remember to protect your privacy by only using information you consider public."
product: "Apps"
...
breadcrumbs:
  ...
  - title: "Creating an OAuth app"
    href: "/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app"
---
...
>
> For more information, see [Differences between GitHub Apps and OAuth apps](/en/apps/oauth-apps/building-oauth-apps/differences-between-github-apps-and-oauth-apps) and [About creating GitHub Apps](/en/apps/creating-github-apps/about-creating-github-apps/about-creating-github-apps).
